...
class Rooms(models.Model):
    RoomsStatus = models.CharField(max_length=100, default="unavailable")

class Clinic(models.Model):
    clinicName = models.CharField(max_length=50)
    specialization = models.ForeignKey(Specialization, on_delete=models.CASCADE)
    location = models.ForeignKey(Location, on_delete=models.CASCADE)
    related_hospital = models.ForeignKey(Hospital, on_delete=models.CASCADE, null=True, blank=True)
...
class Notification(models.Model):
    ...
    doctorName = models.CharField(max_length=100,default="Your Name")
