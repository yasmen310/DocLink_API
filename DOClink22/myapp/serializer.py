...
class HospitalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Hospital
        fields = ['id','hospitalName','hospitalIMG','location_details','departments','available_departments','location']
...
class ClinicSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Clinic
        fields = ['id', 'clinicName', 'specialization_name', 'location_details','related_hospital ', 'specialization','location']
        extra_kwargs = {
...
class DoctorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Doctor
        fields = [ 'doctor_id','doctorIMG', 'doctorName','email', 'specialization_name', 'hospital_name','specialization','hospital']
    def get_specialization_name(self, obj):
        return obj.specialization.specializationName
    def get_hospital_name(self, obj):
        return obj.hospital.hospitalName
...
class PatientSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Patient
        fields = ['patient_id','patientIMG','patientName', 'report', 'location_details','prescription','location', 'email']
        extra_kwargs = {
            'location': {'required': True}  # Mark location as required
        }
