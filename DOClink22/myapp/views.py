...
from .serializer import SpecializationSerializer,UserSerializer, ClinicSerializer, LocationSerializer, DoctorSerializer, AppointmentSerializer, PatientSerializer, HospitalSerializer, BedSerializer, ClinicScheduleSerializer, NotificationSerializer, RoomsSerializer, AssistentSerializer, ChatboxSerializer
...
class AssistentListView(generics.ListCreateAPIView):
    queryset = Assistent.objects.all()
    serializer_class = AssistentSerializer
  

class AssistentDetailView(generics.RetrieveUpdateDestroyAPIView):
    queryset = Assistent.objects.all()
    serializer_class = AssistentSerializer
...
class ChatboxListView(generics.ListCreateAPIView):
    queryset = Chatbox.objects.all()
    serializer_class = ChatboxSerializer

class ChatboxDetailView(generics.RetrieveUpdateDestroyAPIView):
    queryset = Chatbox.objects.all()
    serializer_class = ChatboxSerializer
