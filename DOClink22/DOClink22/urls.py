...
urlpatterns += [
    path('api/notification/', views.NotificationListView.as_view(), name='api-notification-list-create'),
    path('api/Notification/<int:pk>/',views.NotificationDetailView.as_view(), name='api-NotificationDetailView'),
]
urlpatterns += [
    path('api/rooms/', views.RoomsListView.as_view(), name='api-rooms-list-create'),
    path('api/rooms/<int:pk>/',views.RoomsDetailView.as_view(), name='api-roomsDetailView'),

]
urlpatterns += [
    path('api/assistant/', views.AssistentListView.as_view(), name='api-assistant-list-create'),
    path('api/assistant/<int:pk>/',views.AssistentDetailView.as_view(), name='api-assistantDetailView'),

]
urlpatterns += [
    path('api/chatbox/', views.ChatboxListView.as_view(), name='api-chatbox-list-create'),
    path('api/chatbox/<int:pk>/',views.ChatboxDetailView.as_view(), name='api-chatboxDetailView'),
